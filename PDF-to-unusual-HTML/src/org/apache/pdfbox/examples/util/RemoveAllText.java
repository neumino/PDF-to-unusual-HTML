...
public class RemoveAllText
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        else
        {
            ...
            try
            {
                document = PDDocument.load( "/home/michel/Documents/etudes/Tsinghua/M2/arnetminer/pdfBox2html/data/pdf/test3.pdf" );
                ...
                document.save( "/home/michel/Documents/etudes/Tsinghua/M2/arnetminer/pdfBox2html/data/pdf/test3NoText.pdf" );
            }
            finally
            {
                if( document != null )
